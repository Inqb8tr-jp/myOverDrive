...
#define PLUGIN_URI "http://github.com/Inqb8tr-jp/myOverDrive"
...
float apply(const myOverDrive* pedal, const float a);
...
static LV2_Handle instantiate(
		...
		myOverDrive* instance = (myOverDrive*)malloc(sizeof(myOverDrive));
		return instance;
}

static void connect_port(LV2_Handle instance, uint32_t port, void* data)
{
	myOverDrive* pedal = (myOverDrive*)instance;
	switch ((Ports)port) {
		case PEDAL_GAIN:
...
{
	const myOverDrive* pedal = (const myOverDrive*)instance;
